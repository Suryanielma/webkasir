...
<div class="flex flex-col h-full mt-[-10px]">
    ...
    <div class="flex justify-between items-start mb-4">
        <div>
            <h2 class="text-4xl font-bold font-serif text-black mb-1">Sesi Kasir</h2>
            <p class="text-sm font-bold text-gray-500 font-serif">{{ now()->locale('id')->isoFormat('dddd, D MMMM YYYY') }}</p>
        </div>
    ...
    <div class="flex gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg border border-gray-400 p-5 w-[200px] flex flex-col justify-between shadow-sm">
            ...
            <p class="text-4xl font-bold font-serif text-black mb-6">{{ $sesiAktif ? $sesiAktif->transaksiPenjualan->count() : 0 }}</p>
        ...
        <div class="bg-white rounded-lg border border-gray-400 p-5 w-[240px] flex flex-col justify-between shadow-sm">
            ...
            <p class="text-3xl font-bold font-serif text-black mb-6">Rp {{ number_format($sesiAktif ? $sesiAktif->transaksiPenjualan->sum('total_harga') : 0, 0, ',', '.') }}</p>
