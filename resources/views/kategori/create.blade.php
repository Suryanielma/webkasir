...
<div class="max-w-2xl mx-auto w-full">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl md:text-2xl font-bold tracking-tight text-gray-900">Tambah Kategori</h2>
    </div>
    ...
    <form action="{{ route('kategori.store') }}" method="POST"
        ...
        <div>
            ...
            <textarea name="deskripsi" rows="3"
                placeholder="cth: Menu makanan berat soto dan pelengkapnya"
                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#c5cb9f] text-gray-800 bg-white resize-none">{{ old('deskripsi') }}</textarea>
        </div>
