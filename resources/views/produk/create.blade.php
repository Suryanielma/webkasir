                ...
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-[#c5cb9f] transition cursor-pointer"
                    ...
                    <div id="preview-container-form" class="hidden mb-3">
                        <img id="preview-img-form" src="" alt="Preview"
                            class="w-24 h-24 object-cover rounded-xl mx-auto">
                    </div>
                    <span class="material-icons-outlined text-gray-300 !text-[40px]" id="upload-icon">add_photo_alternate</span>
                    <p class="text-sm text-gray-400 mt-2" id="upload-text">Klik untuk upload gambar</p>
        ...
        <div class="w-72 sticky top-6">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <div id="preview-img-wrapper"
                    class="w-full h-40 bg-[#f7f4e9] rounded-xl flex items-center justify-center mb-4 overflow-hidden">
                    <span class="material-icons-outlined text-gray-300 !text-[48px]" id="preview-placeholder">fastfood</span>
                    <img id="preview-img-card" src="" alt="" class="hidden w-full h-full object-cover rounded-xl">
                </div>

                {{-- Info --}}
                <h3 id="preview-nama" class="font-semibold text-gray-800 text-base">Nama Produk</h3>
                <p id="preview-kategori" class="text-xs text-gray-400 mt-0.5 mb-3">Kategori</p>

                <div class="flex items-center justify-between">
                    <p id="preview-harga" class="text-[#5a4a2f] font-semibold text-sm">Rp 0</p>
                    <span id="preview-status"
                        class="bg-green-50 text-green-600 text-xs font-medium px-3 py-1 rounded-full border border-green-200">
                        Tersedia
                    </span>
                </div>
            </div>
